...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu Oct 02 21:29:49 ART 2014
  */
public class parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\006\000\002\012\011\000\002\012\011\000\002\027\004" +
  ...
  protected static final short[][] _action_table = 
    ...
    "\002\000\004\013\uffd8\001\002\000\030\010\uffe2\011\uffe2" +
    ...
    "\uffd7\001\002\000\004\005\246\001\002\000\004\013\uffd6" +
...
table.insertLevel();
		...
		RESULT = new ReturnStmt(e,wleft+1,wright+1);
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 43: // method_call_stmt ::= WEXTERNINVK LPAR STRING_LITERAL COMMA WVOID arg_invoc RPAR 
            {
		...
		RESULT=new ExternInvkStmt(s,a,wleft+1,wright+1);
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 42: // method_call_stmt ::= WEXTERNINVK LPAR STRING_LITERAL COMMA type arg_invoc RPAR 
            {
              MethodCallStmt RESULT =null;
		int wleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-6)).left;
		int wright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-6)).right;
		...
		RESULT=new ExternInvkStmt(s,a,wleft+1,wright+1);
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 41: // method_call_stmt ::= ID LPAR expr_parameters RPAR 
            {
              MethodCallStmt RESULT =null;
		int ileft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)).left;
		int iright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)).right;
...
if (table.search(i) == null) parser.report_fatal_error("ID desconocido.",i);
		...
		s.add(new simpleSymbol(i, null, t,  offset.getOffSet())); RESULT = s;
		...
		int sright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		LinkedList<absSymbol> s = (LinkedList<absSymbol>)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		s.add(new arraySymbol(i,Type.UNDEFINED,il.getValue(), null, offset.getOffSet())); RESULT = s;
...
if (p != null) ((functionSymbol)table.search(i)).setParameters(p); if (table.insertSymbolList(p)==null) parser.report_fatal_error("ID ya difinido: ",p.toString());offset = new Labels();
		...
		int iright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		String i = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
functionSymbol f = new functionSymbol(i, v, null); if (table.insertSymbol(f) == null) parser.report_fatal_error("ID ya difinido: ",i); table.insertLevel();offset = new Labels();
...
if (p != null) ((functionSymbol)table.search(i)).setParameters(p); if (table.insertSymbolList(p)==null) parser.report_fatal_error("ID ya difinido: ",p.toString()); offset = new Labels();
		...
		int iright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		String i = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
functionSymbol f = new functionSymbol(i, t, null); if (table.insertSymbol(f) == null) parser.report_fatal_error("ID ya difinido: ",i); table.insertLevel();offset = new Labels();
...
if (table.insertSymbol(new arraySymbol(i, t, il.getValue(), null, offset.getOffSet())) == null) parser.report_fatal_error("ID ya difinido: ",i);
