...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon Sep 29 14:45:06 ART 2014
  */
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		absSymbol a = table.search(i); if (a == null) parser.report_fatal_error("ID desconocido.",i); else { if (a instanceof functionSymbol) RESULT=new InternInvkExpr(i,p,((functionSymbol)a).type,ileft+1,iright+1); else parser.report_fatal_error("ID "+i+"no es una funcion",i); }
