...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Tue Oct 07 21:08:41 ART 2014
  */
...
if (table.search(i) == null) parser.report_fatal_error("ID desconocido.",i);
		...
		int bright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		Block b = (Block)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
setAst.add(new completeFunction((functionSymbol)table.search(i), b, -offset.temp-(-offset.globalParam))); table.deleteLevel();
