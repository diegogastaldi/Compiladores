...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu Sep 18 13:34:37 ART 2014
  */
public class parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short[][] _action_table = 
    ...
    "\005\uffc5\007\uffc5\010\uffc5\012\uffc5\013\uffc5\026\uffc5\027" +
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		absSymbol a = table.search(i); if (a == null) parser.report_fatal_error("ID desconocido.",i); else RESULT=new ArrayLocation(i,a.type,table.getBlockId(),e,ileft+1,iright+1);
		...
		absSymbol a = table.search(i); if (a == null) parser.report_fatal_error("ID desconocido."+i,i); else RESULT=new VarLocation(i,a.type, table.getBlockId(),ileft+1,iright+1);
		...
		absSymbol a = table.search(i); if (a == null) parser.report_fatal_error("ID desconocido.",i); else { if (a instanceof functionSymbol) RESULT=new InternInvkExpr(i,p,((functionSymbol)a).type,ileft+1,iright+1);}
...
table.insertLevel();
		...
		int pright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).right;
		LinkedList<Expression> p = (LinkedList<Expression>)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		if (table.search(i) == null) parser.report_fatal_error("ID desconocido.",i); else RESULT = new InternInvkStmt(i, p,ileft+1,iright+1);
