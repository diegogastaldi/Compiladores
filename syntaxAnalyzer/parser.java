...
import intermediateCode.Global;

/** CUP v0.11a beta 20060608 generated parser.
  * @version Tue Oct 14 09:40:07 ART 2014
  */
...
class CUP$parser$actions {
  ...
  public static LinkedList<Global> globals = new LinkedList<Global>();
...
if (table.search(i) == null) parser.report_fatal_error("ID desconocido.",i);
		...
		int sright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		LinkedList<absSymbol> s = (LinkedList<absSymbol>)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		s.add(new arraySymbol(i,Type.UNDEFINED,il.getValue(), null, offset.getOffSet(il.getValue()), isGlobal));if (isGlobal) globals.add(new Global(i, 4*il.getValue())); RESULT = s;
		...
		int sright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		LinkedList<absSymbol> s = (LinkedList<absSymbol>)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		s.add(new simpleSymbol(i, null, Type.UNDEFINED, offset.getOffSet(), isGlobal)); if (isGlobal) globals.add(new Global(i, 4)); RESULT = s;
...
isGlobal = false; functionSymbol f = new functionSymbol(i, t, null); if (table.insertSymbol(f) == null) parser.report_fatal_error("ID ya difinido: ",i); table.insertLevel();offset.restart();
		...
		int iright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		String i = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
if (table.insertSymbol(new simpleSymbol(i, null, t, offset.getOffSet(), isGlobal)) == null) parser.report_fatal_error("ID ya difinido: ",i);if (isGlobal) globals.add(new Global(i, 4));
...
if (table.insertSymbol(new arraySymbol(i, t, il.getValue(), null, offset.getOffSet(il.getValue()), isGlobal)) == null) parser.report_fatal_error("ID ya difinido: ",i);if (isGlobal) globals.add(new Global(i, 4*il.getValue())); 
